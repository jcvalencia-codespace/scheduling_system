...
export default function TabNav() {
  ...
  return (
    <nav className="border-b rounded-xl border-gray-200 bg-gradient-to-r from-white to-gray-50 shadow-sm dark:bg-gray-800 dark:border-gray-700 dark:shadow-sm mb-4 w-full">
