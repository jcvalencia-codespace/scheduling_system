            ...
            <div key={idx} className="bg-white p-4 rounded-lg shadow space-y-3 border border-gray-200">
              ...
              <div className="space-y-2">
                <div>
                  ...
                  <div className="font-medium">{entry.sectionDetails.name}</div>
                </div>
                <div className="grid grid-cols-2 gap-2">
                  <div>
                    <label className="text-xs text-gray-500">Year Level:</label>
                    <div>{entry.sectionDetails.yearLevel}</div>
                  </div>
                  <div>
                    <label className="text-xs text-gray-500">Course:</label>
                    <div>{entry.sectionDetails.course}</div>
                  </div>
                </div>
                <div>
                  <label className="text-xs text-gray-500">Department:</label>
                  <div>{entry.sectionDetails.department}</div>
                </div>
              </div>
