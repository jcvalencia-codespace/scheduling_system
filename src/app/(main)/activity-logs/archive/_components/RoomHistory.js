          ...
          {currentItems.map((entry, idx) => (
            <div key={idx} className="bg-white p-4 rounded-lg shadow space-y-3 border border-gray-200">
              ...
              <div className="space-y-2">
                <div>
                  <label className="text-xs text-gray-500">Room Code:</label>
                  <div className="font-medium">{entry.roomDetails.code}</div>
                </div>
                <div>
                  <label className="text-xs text-gray-500">Room Name:</label>
                  <div className="font-medium">{entry.roomDetails.name}</div>
                </div>
                <div className="grid grid-cols-2 gap-2">
                  <div>
                    <label className="text-xs text-gray-500">Capacity:</label>
                    <div>{entry.roomDetails.capacity}</div>
                  </div>
                  <div>
                ...
                <div>
                  ...
                  <div>{entry.roomDetails.department}</div>
                </div>
              </div>
