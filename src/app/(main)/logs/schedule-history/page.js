  ...
  const logs = [
    {
      ...
      details: 'Added BSCS 1A schedule for Term 1 2024-2025',
    ...
    },
    {
      ...
      details: 'Updated room for BSIT 2B Math class',
    ...
    },
    {
      ...
      details: 'Removed conflicting schedule for Room 301',
    ...
    <div className="px-4 sm:px-6 lg:px-8 py-8">
      <div className="sm:flex sm:items-center">
        <div className="sm:flex-auto">
          <h1 className="text-2xl font-semibold text-gray-900">Schedule History</h1>
          <p className="mt-2 text-sm text-gray-700">
            View all schedule-related activities and changes.
          </p>
        </div>
      </div>
                  ...
                  {filteredLogs.map((log, index) => (
                    <tr key={log.id}>
                      ...
                      <td className="whitespace-nowrap px-3 py-4 text-sm">
                        <span className={getActionColor(log.type)}>
                          {log.action}
                        </span>
                      </td>
                      <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
