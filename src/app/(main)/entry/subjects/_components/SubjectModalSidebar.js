...
export default function SubjectModalSidebar({ subject }) {
  return (
      ...
      <div className="h-full flex flex-col">
        <div className="mb-8">
          ...
          <p className="mt-2 text-blue-100 text-sm">
            {subject
              ...
              : "Create a new subject by filling out the required information"}
          </p>
        </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start">
                ...
                <span>Enter the subject code</span>
              </li>
              <li className="flex items-start">
                <span className="inline-flex items-center justify-center w-5 h-5 rounded-full bg-white/20 text-xs mr-2 mt-0.5 flex-shrink-0">
                  2
                </span>
                <span>Provide the subject name</span>
              </li>
              <li className="flex items-start">
                <span className="inline-flex items-center justify-center w-5 h-5 rounded-full bg-white/20 text-xs mr-2 mt-0.5 flex-shrink-0">
                  3
        ...
        <div className="mt-auto pt-6">
          <div className="text-sm text-blue-100">
            <p>Subject Code Format:</p>
            <div className="mt-1 grid grid-cols-1 gap-2 text-xs">
              <span className="px-2 py-1 rounded bg-white/10">Use uppercase letters and numbers (e.g., COMP101)</span>
            </div>
          </div>
        </div>
      </div>
